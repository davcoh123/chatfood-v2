  ...
  return (
    <div className="container mx-auto p-4 md:p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Main Column: Reservations (Moved here) */}
        <div className="lg:col-span-2 space-y-6">
          <div className="space-y-4">
            ...
            <div className="relative overflow-hidden rounded-xl border bg-background shadow-sm group hover:shadow-md transition-all duration-300 min-h-[400px]">
              <div className="pointer-events-none blur-[3px] opacity-30 p-4 grayscale transition-all duration-500 group-hover:grayscale-0 group-hover:opacity-40 h-full">
                <ReservationsCalendar />
              </div>
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-background/60 backdrop-blur-[1px] p-6 text-center">
                <div className="rounded-full bg-amber-500/10 p-4 mb-4 ring-1 ring-amber-500/20 shadow-lg shadow-amber-500/10">
                  <Sparkles className="h-8 w-8 text-amber-500" />
                </div>
                <h3 className="text-2xl font-bold mb-2">Débloquez les Réservations</h3>
                <p className="text-muted-foreground mb-8 max-w-[400px]">
                  Gérez vos réservations et optimisez votre planning avec le plan Premium.
                  Accédez à un calendrier complet et des notifications en temps réel.
                </p>
                <Button 
                  onClick={() => navigate('/offres/premium')} 
                  size="lg"
                  className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white shadow-md border-0"
                >
                  Passer à Premium
                </Button>
              </div>
