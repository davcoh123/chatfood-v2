...
const Dashboard = () => {
  ...
  // NOTE: We no longer force redirect to /onboarding
  // The OnboardingWidget is now displayed on the dashboard instead
  ...
  // NOTE: Removed the early return for onboarding - widget shows on dashboard now
